-- Add sample package data for Flight Simulator event with correct data types
...
-- Basic Package
('Gaming', 'Flight Simulator', 'Basis Pakket', 8, 15, 2, 299, 361.79, 0.5, 0.5, 0.5,
...
-- Standard Package  
('Gaming', 'Flight Simulator', 'Standaard Pakket', 10, 20, 3, 449, 543.29, 0.5, 0.5, 0.5,
...
-- Premium Package
('Gaming', 'Flight Simulator', 'Premium Pakket', 15, 30, 4, 649, 785.29, 1, 1, 0.5,
...
-- Ultimate Package
('Gaming', 'Flight Simulator', 'Ultimate Pakket', 20, 40, 5, 899, 1087.79, 1, 1, 0.5,
